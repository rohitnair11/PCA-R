...
# set working directory to point to the folder containing pca.R
...
inter_intra_species_dist <- function(data, distance_func_name) {
  ...
  # where n_samples is total # of samples and
  # attribute number is the total # of attributes.
